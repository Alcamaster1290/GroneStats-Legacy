...
class Radar:
    ...
    def __init__(
        ...
        label_fontsize=20, range_fontsize=8.5, label_color="#000000", range_color="#000000"
        ):
        """
    ...
    def plot_radar(self, ranges, params, values, radar_color, filename=None, dpi=300,
        ...
        ## add credits 
        ax.text(22, -21.5, 'Créditos a: Rami Moghadam / Creado por: Alvaro Cáceres', fontfamily=self.fontfamily, ha='right',
    ...
    def __add_labels(self, params, ax, return_list=False, radius=19, range_val=False):
        ...
        for i in range(len(params)):
            ...
            ax.text(x, y, p, rotation=-np.rad2deg(rot), ha='center', va='center', 
                    fontsize=size, fontfamily=self.fontfamily, fontdict=dict(color=color, weight='bold'), zorder=10)
    ...
    def __add_ranges(self, ranges, ax):
        ...
        for rng in ranges:
            value = np.linspace(start=rng[0], stop=rng[1], num=10, dtype=int)
